      ...
      <section class="sonar-panel section-lined space-y-10" aria-live="polite">
        ...
        <div class="mt-6 p-4 bg-slate-800/30 rounded-lg border border-slate-700/50">
          <p class="text-sm text-slate-300 leading-relaxed">
            ...
            <br>
            <span class="text-slate-400 text-xs mt-1 inline-block">iguiendo estándares de Laravel/Symfony. Ver <a href="/readme" class="text-cyan-400 hover:underline font-medium">COVERAGE.md</a> para detalles completos.</span>
          </p>
        </div>
      </section>
    </div>
