...
- `operations.md`: cómo levantar el servicio, variables de entorno clave y endpoint expuesto.
- `testing.md`: cómo ejecutar la batería de tests propia del microservicio.
